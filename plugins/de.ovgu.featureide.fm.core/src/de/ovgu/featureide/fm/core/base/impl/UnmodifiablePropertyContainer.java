...
public class UnmodifiablePropertyContainer implements IPropertyContainer {
	...
	static UnsupportedOperationException exception = new UnsupportedOperationException(
			"Manipulation is not allowed. This is an unmodifiable property container");
